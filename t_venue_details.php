...
if(isset($_SESSION['td_id'])){
	...
	$t_dates=$account->getTournamentDates($td_id);
}else{
...
if(!empty($_POST)){
	...
	if($result['t_id']!=""){
		...
		$_SESSION["td_id"] = $t_id;
		if($status!="" && $status==0){
			header("location: t_travel_lunch_time.php?id=$t_id");
		}else{
					...
					<form method="post" action="t_venue_details.php" id="form1" enctype="multipart/form-data">
						<?php if (isset($_GET['id']) && !empty($play_tournaments)){ ?>
							...
							<div id="venue_details">
								...
								<div class="form-row">
									<input type="hidden" class="form-control" name="no_venue" id="no_venue" value="<?php echo $no_venues; ?>"/>
									<div class="form-group col-md-3  col-sm-3">
										<label>Tournament Venue :</label>
										<?php if(!isset($_GET['status'])){?>
											<input type="text" class="form-control" name="venue1" id="venue1" value="<?php echo $play_tournaments[0]['venue_name']; ?>" readonly />
										<?php }else{ ?>
											<input type="text" class="form-control" name="venue1" id="venue1" value="<?php echo $play_tournaments[0]['venue_name']; ?>" />
										<?php } ?>
									</div>
									<div class="form-group col-md-9 col-sm-9">
										...
										<div class="form-group row">
											<div class="col-md-4">
												<select class="browser-default custom-select country my-2" name="country1" id="1" required >
													<?php if(!isset($_GET['status'])){?>
														<option value="<?php echo $play_tournaments[0]['country_id']; ?>" selected ><?php echo $play_tournaments[0]['country']; ?></option>
													<?php }else{ ?>
														<option value="<?php echo $play_tournaments[0]['country_id']; ?>"  selected><?php echo $play_tournaments[0]['country']; ?></option>
													<?php } ?>
												</select>
											...
											<div class="col-md-4">
												<select class="browser-default custom-select state my-2" name="state1" id="state1" required >
													<?php if(!isset($_GET['status'])){?>
														<option value="<?php echo $play_tournaments[0]['state_id']; ?>" selected><?php echo $play_tournaments[0]['state']; ?></option>
													<?php }else{ ?>
														<option value="<?php echo $play_tournaments[0]['state_id']; ?>"  selected><?php echo $play_tournaments[0]['state']; ?></option>
													<?php } ?>
												</select>
											...
											<div class="col-md-4">
												<?php if(!isset($_GET['status'])){?>
													<input type="text" class="form-control" id="city1" name="city1" placeholder="City" value="<?php echo $play_tournaments[0]['city']; ?>" readonly>
												<?php }else{ ?>
													<input type="text" class="form-control" id="city1" name="city1" placeholder="City" value="<?php echo $play_tournaments[0]['city']; ?>" >
												<?php } ?>
											</div>
										</div>
									</div>
									<div class="form-group col-md-3">	
										...
										<input type="text" class="form-control date" name="start_date1" id="start_date1" autocomplete="off" value="<?php echo $t_dates['t_start_date']; ?>" readonly  /><hr />
									</div>
									<div class="form-group col-md-3">
										<label>Start Time<span class="red-text"></span>:</label>
										<input type="time" name="start_time1"  class="form-control timepicker2" id="start_time1" value="<?php echo $play_tournaments[0]['start_time']; ?>"><hr />
									</div>
									<div class="form-group col-md-3">
										<label>End Date:</label>
										<input type="text" class="form-control date" name="end_date1" id="end_date1" autocomplete="off" value="<?php echo $t_dates['t_end_date']; ?>" readonly /><hr />
									</div>
									<div class="form-group col-md-3">
										<label>End Time<span class="red-text"></span>:</label>
										<input type="time" name="end_time1"  class="form-control timepicker2" id="end_time1" value="<?php echo $play_tournaments[0]['end_time']; ?>"><hr />
									</div>
									<div class="form-group col-md-12 date_err red-text"></div>
									<div class="form-group col-md-12">
										<label>No of Courts :</label>
										<?php if(!isset($_GET['status'])){?>
											<input type="number" class="form-control no_courts" name="no_courts1" id="no_courts1" min="1" value="<?php echo $play_tournaments[0]['no_courts']; ?>" readonly />
										<?php }else{ ?>
											<input type="number" class="form-control no_courts" name="no_courts1" id="no_courts1" min="1" value="<?php echo $play_tournaments[0]['no_courts']; ?>" />
										<?php } ?>
									</div>
								</div>
								<?php //$i++;//} ?>
						...
						<?php }else{ ?>
							...
							<div id="venue_details">
								<div class="form-row">
									<input type="hidden" class="form-control" name="no_venue" id="no_venue" value="1"/>
									<div class="form-group col-md-3 col-sm-3">
										<label>Tournament Venue :</label>
									...
									<div class="form-group col-md-9 col-sm-9">
										...
										<div class="form-group row">
											...
											<div class="col-md-4">
												<input type="text" class="form-control" id="city'+i+'" name="city1" placeholder="City" value="" required>
											</div>
										</div>
									</div>
									<div class="form-group col-md-3"><label>Start Date :</label>
										<input type="text" class="form-control" name="start_date1" autocomplete="off" value="<?php echo $t_dates['t_start_date']; ?>" readonly id="start_date1" />
									</div>
									<div class="form-group col-md-3"><label>Start Time<span class="red-text"></span>:</label>
										<input type="time" name="start_time1"  class="form-control" id="start_time1" value="" required>
									</div>
									<div class="form-group col-md-3">
										<label>End Date:</label>
										<input type="text" class="form-control" name="end_date1" autocomplete="off" value="<?php echo $t_dates['t_end_date']; ?>" readonly id="end_date1" />
									</div>
									<div class="form-group col-md-3">
										<label>End Time<span class="red-text"></span>:</label>
										<input type="time" name="end_time1"  class="form-control" id="end_time1" value="" required>
									</div>
									<div class="form-group col-md-12 date_err red-text"></div>
									<div class="col-md-12"><label>No of Courts:</label>
										<input type="number" class="form-control no_courts" name="no_courts1" id="no_courts1" id1="1" min="1" required />
									</div>
								</div>
							</div>
						<?php } ?>
...
$(function(){
	$('#end_time1').change(function(){
		...
		if(diff<=0){
			$('.date_err').text("End time should be greater than Start Time. Please enter the time in 24 hours format");
			return false;
		}else{
			$('.date_err').text("");
			return false;
	...
	$('#submit').click(function(){
		...
		var msg='As per the details (No of courts and the start/End time) entered,  In the specified venue max of ';
		var i=1;
		while(no_venues>0){
			...
			var total_no_players=total_no_matches;
			msg+=total_no_players;
			no_venues--;
			i++;
		}
		msg+=' players can register to your tournament. If you anticipate more players to register then you need to extend the  <span class="red-text">Tournament End date</span> or  <span class="red-text">Tournament End time</span> or add more  <span class="red-text">courts</span>.';
		$('.msg').html(msg);
	});
