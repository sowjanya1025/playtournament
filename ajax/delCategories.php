	...
	if($result1){
		...
		if ($result) {
			while ($row=mysqli_fetch_assoc($result)){
				$query3="SELECT tc.*,subcat.subcategory_name,subcat.category_id FROM `tournament_categories` tc left JOIN tournament_subcategory_master_table subcat on subcat.id=tc.subcategory_id WHERE tc.subcategory_id='".$row['id']."' and tc.tournament_details_id='".$td_id."'";
